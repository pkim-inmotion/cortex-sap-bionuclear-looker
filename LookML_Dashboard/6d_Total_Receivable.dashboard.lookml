- dashboard: total_receivable
  ...
  - name: ''
    type: text
    title_text: ''
    subtitle_text: ' <a href="/dashboards/bio_nuc_cortex_sap_operational::accounts_receivable?">Home</a>'
    body_text: ''
    row: 20
    col: 0
    width: 24
  ...
  - name: Currency
    title: Currency
    type: field_filter
    default_value: "{{ _user_attributes['bio_nuc_default_value_currency_required'] }}"
    allow_multiple_values: true
    required: false
    ui_config:
      type: dropdown_menu
