- dashboard: balance_sheet_subtotal3_table
  ...
  - name: Chart of Accounts
    ...
    type: field_filter
    # default_value: YCOA
    default_value: "{% if _user_attributes['bio_nuc_sap_sql_flavor']=='S4' %}{% assign coa = 'YCOA'%}{%else%}{% assign coa = 'CA01' %}{% endif %}{{coa}}"
    allow_multiple_values: false
    required: true
    ui_config:
      type: dropdown_menu
